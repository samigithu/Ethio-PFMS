        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <div class="icon fas fa-crow">
                <i class="icon fas fa-crow "></i>
              </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3>{{$order}}<sup style="font-size: 20px">Birr</sup></h3>

                <p>Orders Approved</p>
              </div>
              <div class="icon fas fa-hand-holding-usd">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <div class="icon fas fa-egg">
                <i class="icon fas fa-egg"></i>
              </div>
              <a href="#" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
