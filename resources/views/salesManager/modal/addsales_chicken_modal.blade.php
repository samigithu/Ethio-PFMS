<div class="modal fade" id="modal-add_sale_chicken">
...
<!-- //////// -->
 <form action="{{url('add_sale_chickens')}}" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select name="PBID" class="form-control" required="">
                                 <option >--Select Chickens--</option>
                               @foreach($product as $products)
                              <option value="{{$products->batch_id}}"}}>{{$products->id}}:Name:{{$products->name}}:Quantity:{{$products->quantity}}
                              </option>
                              @endforeach
                             </select>
                            </div>
